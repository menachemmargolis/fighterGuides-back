...
characters = [
    {name: "Ky Kiske",  grid_image: "https://cdn.wikimg.net/en/strategywiki/images/thumb/e/e7/Portrait_GGS_Ky.png/64px-Portrait_GGS_Ky.png", description: "A serious man who dedicates himself completely to his work, the people, and his morals. His love for justice and determination to help those less fortunate is reflected in all aspects of his life. On the other hand, this also means he can show rather extreme dislike for anything that disrupts the peace or breaks the rules. After taking his position as King, this enthusiasm shifted into a broader perspective, allowing him to see the world from a variety of viewpoints. This isn't to say, however, that he can't still come off as naïve and emotional at times.", detail_image:"https://www.fightersgeneration.com/nf8/char5/ggstrive/ky-guiltygear-strive-artwork.png"},
    {name: "Sol Badguy", grid_image:"https://cdn.wikimg.net/en/strategywiki/images/thumb/0/0d/Portrait_GGS_Sol.png/64px-Portrait_GGS_Sol.png" , description: "A blunt and short-tempered man. He only speaks when required, and uses as few words as he can get away with. He's not very good at explaining things, so he prefers to express himself with his aggressive behavior and attitude. While most see him as selfish and violent, those closest to him accept him for who he is.", detail_image:"https://www.fightersgeneration.com/nf8/char5/ggstrive/solbadguy-guiltygear-strive-artwork.png" },
    {name: "Ramlethal Valentine", grid_image:"https://cdn.wikimg.net/en/strategywiki/images/thumb/8/85/Portrait_GGS_Ramlethal.png/64px-Portrait_GGS_Ramlethal.png", description: "She is a 'Valentine,' a life form created in the image of humanity. In accordance with the orders from her mother implanted in her memories, she declared war against humanity. However, through her interactions with Sol and everyone, she came to know emotion, and eventually became an ally to mankind.", detail_image: "https://www.fightersgeneration.com/nf9/char/ramlethal-valentine-guiltygear-strive.png"}
]
